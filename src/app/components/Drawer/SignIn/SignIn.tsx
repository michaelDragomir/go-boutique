	...
	return (
		<main className='w-full flex flex-col items-center justify-center px-4'>
			<div className='max-w-sm w-full text-gray-600 space-y-5'>
					...
					<div className='flex items-center justify-between text-sm'>
						<div className='flex items-center gap-x-3'>
							...
							<label
								...
								className='relative flex w-5 h-5 bg-white peer-checked:bg-[#BBA14F] rounded-md border ring-offset-2 ring-[#BBA14F] duration-150 peer-active:ring cursor-pointer after:absolute after:inset-x-0 after:top-[3px] after:m-auto after:w-1.5 after:h-2.5 after:border-r-2 after:border-b-2 after:border-white after:rotate-45'
							></label>
							<span>Remember me</span>
						</div>
						<a
							href='javascript:void(0)'
							className='text-center text-black hover:text-zinc-400'
						>
							Forgot password?
						</a>
					</div>
				...
				<button className=' animate-fadeIn group w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-full text-sm font-medium hover:bg-black duration-150 active:bg-gray-100'>
					<svg
						className='w-5 h-5'
						viewBox='0 0 48 48'
						fill='none'
