...
import SearchModal from '@/app/components/SearchForm/SearchModal';
						...
						<div className='phone:hidden tablet:flex items-center lg:gap-4 phone:gap-4 xl:gap-8'>
							...
							<div className='flex border border-slate-500 rounded-md  phone:p-[3px] xl:p-[7px] hover:border-slate-800'>
								...
								<h4 className='border-r border-goPink cursor-pointer text-sm text-slate-500 flex items-center'>
									<span className='mr-1 phone:hidden md:block'>Favorites</span>
								</h4>
							...
							<div className='cursor-pointer text-black'>
								<div className='flex items-center'>
									...
									<span className='sm:absolute sm:top-[15px] sm:right-[10px] tablet:absolute tablet:top-[12px] tablet:right-[10px] md:absolute md:top-[40px] md:right-[10px] lg:static text-slate-100 h-6 w-6 rounded-full flex items-center justify-center text-sm bg-slate-500 drop-shadow-[0_2px_2px_rgba(0,0,0,0.3)] animate-pulse'>
										1
									</span>
...
// phone:block sm:hidden w-9/12 mx-auto mt-[40px] z-aboveAll relative
